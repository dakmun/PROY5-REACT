...
import { Card, CardContent, CardMedia, Typography, CardActions, Button, Rating , Chip, Box} from '@mui/material';
...
const ProductCard = ({ product }) => {
 ...
 <Link to={`/product/${product.id}`} style={{ textDecoration: 'none' }}>
        ...
        '@media (max-width: 600px)': {
         ...
         {product.title.slice(0, 20)}
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' , gap: 2,
                            ...
                            <Typography variant="h5"  sx={{ margin: 0 ,color: '#333' ,opacity: '0.7', fontWeight: 'bold',
                                '@media (max-width: 600px)': {
                            ...
                            <Typography variant="h6"  sx={{ margin: 0, textDecoration: 'line-through',color: '#333' ,opacity: '0.7', fontWeight: 'bold',
                                '@media (max-width: 600px)': {
        ...
        variant="body1" sx={{ marginLeft: 1, color: '#333', opacity: '0.7' ,fontSize: '0.8rem',
          '@media (max-width: 600px)': {
            display: 'none',
          },
