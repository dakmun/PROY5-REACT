...
const ProductCardFeatured = ({ product }) => {
  return (
    <Link to={`/product/${product.id}`} style={{ textDecoration: 'none' }}>
      <Card 
        className='featured-product-card-container'
        sx={{ 
          maxWidth: 345, 
          margin: '10px', 
          textAlign: 'center', 
      ...
      >
        <CardMedia
          sx={{ width: '200px', height: 'auto', textAlign: 'center', maxHeight: '200px', minHeight: '200px', objectFit: 'contain'}}
          component="img"
        ...
        <CardContent sx={{padding: '0px', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>  
          ...
          <Typography variant="h6" color="#333" 
            sx={{ marginBottom: 2 , fontSize: '0.9rem', color: '#333', opacity: '0.7' }}
          >
